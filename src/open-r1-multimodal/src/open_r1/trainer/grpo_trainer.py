    ...
    def __init__(
        ...
        **kwargs,
        ...
        if processing_class is None:
            ...
            # print("🚀 Using processing class:", processing_cls)
            # print("📦 [Processing class loaded]:", processing_class)
            # print("📸 [Image processor]:", getattr(processing_class, "image_processor", None))
            # print("🔤 [Tokenizer]:", getattr(processing_class, "tokenizer", None))
